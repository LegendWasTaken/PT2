...
public:
    ...
    [[nodiscard]] float dot (const Vec3 &a) const noexcept;
    [[nodiscard]] float dist(const Vec3 &a) const noexcept;
    [[nodiscard]] float length() const noexcept;
    [[nodiscard]] float length_sq() const noexcept;
    [[nodiscard]] Vec3 cross(const Vec3 &a) const noexcept;
    [[nodiscard]] Vec3 to_unit_vector() const noexcept;
    [[nodiscard]] Vec3 reflect(const Vec3&) const noexcept;
};
